...
%Sumário
\usepackage[]{tocloft}
\cftsetindents{chapter}{0cm}{0cm} %NAO ESTÁ FUNCIONANDO
...
\chapter[Hotspot getting hotter]{\centering{Hotspot getting hotter: the rise in endemism levels and habitat loss and the plight of the Cerrado savannas}}\label{chap1}
